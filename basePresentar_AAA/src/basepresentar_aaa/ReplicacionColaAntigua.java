 ...
 * @author Anita
 */
public class ReplicacionColaAntigua extends javax.swing.JFrame {
    ...
    public ReplicacionColaAntigua(String publicador,String nombrePub) {
        initComponents();
...
//        suscriptorName="TOSHIBA".concat(String.valueOf(slash)).concat("SITIOA");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ReplicacionColaAntigua.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
